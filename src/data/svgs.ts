...
export const svgs: iSVG[] = [
  ...
  },
  {
    ...
    brandUrl: 'https://www.tensorflow.org/extras/tensorflow_brand_guidelines.pdf'
  },
  {
    title: 'Midday',
    category: 'AI',
  ...
  {
    title: 'Knoott',
    category: ['Platform', 'Marketplace', 'Community', 'Social'],
    route: {
      light: '/library/knoott-dark.svg',
      dark: '/library/knoott-light.svg'
    },
    wordmark: {
      light: '/library/knoott_wordmark_dark.svg',
      dark: '/library/knoott_wordmark_light.svg'
    },
    url: 'https://knoott.com/'
  },
  {
    title: 'Kilo Code',
    category: ['AI', 'Devtool'],
